...
module.exports.run = async (client, message, args) => {
   if (!message.member.permissions.has("MANAGE_GUILD")) // sets the permission
            return message.channel.send(`<:negado:755502002619940935> ** ${message.author.username}, Você não tem permissão de Administrador para poder mudar meu prefixo**`);
