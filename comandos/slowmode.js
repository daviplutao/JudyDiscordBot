...
exports.run = async (bot, message, args) => {
    ...
    if (reason > 21600) return message.channel.send("<:negado:755502002619940935> Insira um número de 0 a 21600 para setar o modo lento")
        if (!args[0]) {
            return message.channel.send(`<:negado:755502002619940935> Insira um número de 0 a 21600 para setar o modo lento`)
        }
        if(isNaN(args[0])) return message.channel.send("<:negado:755502002619940935> Isso não é um número.")
